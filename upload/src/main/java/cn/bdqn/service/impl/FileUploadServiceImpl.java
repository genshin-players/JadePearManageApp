...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    public Result fileUpload(MultipartFile file, String savePath) {
        try {
            ...
            FtpUtil.uploadFile("39.107.229.253",21,"admin","1145141919810","/home/admin/","upload/"+savePath+"/"+path,newFilename,file.getInputStream());
            String imageURL = "http://" + "39.107.229.253:81" + "/upload/"+savePath+"/"+path + "/"+ newFilename;
